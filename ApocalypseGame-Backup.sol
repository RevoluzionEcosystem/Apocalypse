...
contract ApocalypseGame is Pausable, Auth {
    ...
    function upgradeWeapon(uint256 _tokenID) external {
        ...
        uint256 amount = checkPrice(weaponUpgradeBUSDPrice, upgradeWeaponToken);
    ...
    function upgradeWand(uint256 _tokenID) external {
        ...
        uint256 amount = checkPrice(wandUpgradeBUSDPrice, upgradeWandToken);
    ...
    function upgradeShield(uint256 _tokenID) external {
        ...
        uint256 amount = checkPrice(shieldUpgradeBUSDPrice, upgradeShieldToken);
